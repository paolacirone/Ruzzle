...
public class FXMLController {
	...
	// matrice come insieme di bottoni, servirà un mapping tra posizione del bottone
	// nella scacchiera e il bottone
	...
	void handleProva(ActionEvent event) {
		...
		// controllo che ci siano solo caratteri alfabetici tra A e Z
	...
	public void setModel(Model m) {
		...
		// facciamo il binding di ogni bottone con la stringProperty
